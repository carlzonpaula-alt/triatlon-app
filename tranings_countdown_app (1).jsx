    ...
    <div className="min-h-screen bg-slate-50 p-4 text-slate-900 md:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="rounded-3xl bg-white p-6 shadow-sm md:p-8">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold tracking-tight md:text-5xl">{goalName}</h1>
              <p className="mt-3 max-w-2xl text-slate-600">Planera framtida pass, markera pass som genomförda och följ vecka, belastning och rekord.</p>
            ...
            <div className="rounded-3xl bg-slate-900 p-6 text-center text-white shadow-sm">
        ...
        <section className="rounded-3xl bg-white p-5 shadow-sm">
          ...
          {viewMode === "Månad" ? (
            <>
              <div className="grid grid-cols-7 gap-2 text-center text-xs font-bold text-slate-500">{['Mån', 'Tis', 'Ons', 'Tor', 'Fre', 'Lör', 'Sön'].map((day) => <div key={day}>{day}</div>)}</div>
        ...
        <section className="grid gap-6 md:grid-cols-[1fr_1.4fr]">
          <div id="workout-form" className="rounded-3xl bg-white p-6 shadow-sm">
